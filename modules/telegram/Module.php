...
namespace core\modules\telegram;
...
class Module extends WebModule implements \yii\base\BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'core\modules\telegram\controllers';
    ...
    public function bootstrap($app)
    {
        ...
        if ($app instanceof \yii\console\Application) {
            ...
            $this->controllerNamespace = 'core\modules\telegram\commands';
        }
        if (!($app instanceof \yii\console\Application)) {
            $config = Yii::$app->settings->get('telegram');
            if (isset($config->api_token)) {
                $app->setComponents([
                    'telegram' => [
                        'class' => 'core\modules\telegram\components\Telegram',
