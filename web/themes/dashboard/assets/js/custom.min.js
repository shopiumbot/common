$(function () {
    ...
    $(".nav-toggler").on("click", function () {
        ...
        if($("#main-wrapper .nav-toggler i").hasClass('icon-menu')){
            $(this).find('i').removeClass('icon-menu').addClass("icon-delete");
        }else{
            $(this).find('i').removeClass('icon-delete').addClass("icon-menu");
        }
    });
    $(".search-box a, .search-box .app-search .srh-btn").on("click", function () {
        ...
        e.preventDefault(), $(this).closest(".card").find('[data-action="collapse"] i').toggleClass("icon-arrow-down icon-arrow-up"), $(this).closest(".card").children(".card-body").collapse("toggle")
    ...
    $(window).resize(function (e) {
        ...
        $(".left-part").toggleClass("show-panel"), $(".show-left-part").toggleClass("icon-menu")
